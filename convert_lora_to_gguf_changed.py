    ...
    with torch.inference_mode():
        ...
        class LoraModel(model_class):  # ty: ignore[unsupported-base]
            ...
            def prepare_tensors(self):
                # Bypass proxy-style models (e.g. Mistral3Model) that delegate
                # prepare_tensors() to self.impl, which skips our get_tensors() override.
                ModelBase.prepare_tensors(self)

            def write(self):
                # Bypass proxy-style models (e.g. Mistral3Model) that delegate
                # write() to self.impl, which skips our get_tensors() override.
